      ...
      <div class="max-w-6xl mx-auto py-8">
        <div class="flex flex-wrap">
          <div class="w-full   text-justify">
            <h4 class="text-lg font-semibold mb-2 text-[#2e3368]">Overview</h4>
            <p class="mb-4">
              This website is operated by Joyfulsuprises. Throughout the site,
              the terms “we”, “us” and “our” refer to Joyfulsuprises.
              Joyfulsuprises offers this website, including all information,
            ...
            <h4 class="text-lg font-semibold mb-2 text-[#2e3368]">
            ...
            <p class="mb-4">
              In no case shall Beauty Krew, our directors, officers, employees,
            ...
            <p class="mb-4">
              You agree to indemnify, defend and hold harmless Beauty Krew and
